...
Which should normally be tried first?
...
SSH is failing. Which commands answer:

```text
Is it running?
Did it fail?
What do the logs say?
Is its process present?
```
...
> Add one thing I learned about investigating services instead of randomly restarting them.

### 🧾 Today's Win

> Add one thing I can now do confidently.
